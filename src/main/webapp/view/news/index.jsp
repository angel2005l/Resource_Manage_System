		...
		<div id="pad-wrapper">
			...
			<div class="table-wrapper products-table section">
				...
				<div class="row-fluid filter-block">
					<form id="searchForm"
						action="<%=basePath%>newsManage?method=news_sel" method="post">
						<div class="pull-right">
							<input type="text" class="search" name="title" placeholder="请输入新闻标题关键字" /> <input
								type="hidden" id="pageNum" name="pageNum" value="${data.data.totalPage }">
							<input type="hidden" id="page" name = "page"
								value="${data.data.page==0 ? 1: data.data.page}" /> <a
